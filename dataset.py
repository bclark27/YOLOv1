...
class VocDetectorDataset(DataLoader.Dataset):
    ...
    def __init__(self, root_img_dir, dataset_file, train, S, preproc=True, return_image_id=False, encode_target=True, class_count=20):
    ...
    def encoder(self, boxes, labels):
        ...
        '''
        grid_num = self.S
        target = torch.zeros((grid_num, grid_num, 5*2+self.class_count)) #
